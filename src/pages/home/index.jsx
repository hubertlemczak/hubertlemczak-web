  ...
  return (
    <section className="relative" id="home">
      <div className="flex flex-col items-center lg:block py-60 lg:py-64">
        <div className="max-w-325 mx-auto md:max-w-none">
      ...
      <HeroSVG className="absolute -z-10 scale-50 -top-1/2 right-1/2 translate-x-1/2 md:z-10 lg:scale-110 lg:-top-40 lg:-right-1/3 lg:translate-x-44" />
    </section>
  );
};

    ...
    <div className="carousel">
      <div className="carousel-track">
        <div className="carousel-item">
          <img src={REACT} alt="" className="h-36" />
        </div>
        <div className="carousel-item">
        ...
        <div className="carousel-item">
          <img src={GIT} alt="" className="h-48" />
        </div>
        <div className="carousel-item">
          <img src={NODEJS} alt="" className="h-28" />
        </div>
        <div className="carousel-item">
          <img src={TAILWIND} alt="" className="h-48" />
        </div>
        <div className="carousel-item">
        ...
        <div className="carousel-item">
          <img src={JEST} alt="" className="h-36" />
        </div>
        <div className="carousel-item">
          <img src={FIGMA} alt="" className="h-24" />
        </div>
        <div className="carousel-item">
          <img src={GITHUB} alt="" className="h-32" />
        </div>
        <div className="carousel-item">
          <img src={JASMINE} alt="" className="h-28" />
        </div>
        <div className="carousel-item">
          <img src={REACT} alt="" className="h-36" />
        </div>
